          ...
          <div className="cp-card">
            ...
            <div className="cp-card-body cp-body">
              ...
              <p>
                ...
                and us, please provide:
              </p>
              <ul>
                <li>
                  <strong>Unboxing Video:</strong> A complete, uncut video of
                  you unboxing the package, showing the sealed package, opening
                  process, and item's condition from all angles.
                </li>
                <li>
                  <strong>360-Degree View:</strong> Record a 360-degree view of
                  the product showing all sides, including any defects or
                  issues.
                </li>
                <li>
                  <strong>Clear Photographs:</strong> High-quality images
                  showing front, back, and side views; product tags and labels;
                  any defects or damages; and original packaging.
                </li>
                <li>
              ...
              <ol>
                <li>
                  ...
                  with your order ID, reason for return, and all required
                  documentation.
                </li>
                <li>
                ...
                <li>
                  Ship the item back using the provided instructions. Keep your
                  shipping receipt for tracking.
                </li>
                <li>
              ...
              <p>
                ...
                damaged/defective items at no additional cost.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  or call <a href="tel:+918925083167">+91 8925083167</a>.
                </li>
              </ul>
            </div>
          </div>
