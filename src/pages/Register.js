        ...
        <div className="auth-brand-panel" aria-hidden="true">
          <div className="auth-brand-content">
            ...
            <p className="auth-brand-subtitle">
              Get access to thousands of premium craft products and exclusive
              member perks.
            </p>
            <ul className="auth-brand-perks">
              <li>
                <span className="perk-icon">🎁</span> Exclusive member offers
              </li>
              <li>
                <span className="perk-icon">📦</span> Order tracking & history
              </li>
              <li>
                <span className="perk-icon">❤️</span> Save to wishlist
              </li>
              <li>
                <span className="perk-icon">⭐</span> Leave product reviews
              </li>
            </ul>
          </div>
        </div>
