...
const ProductListing = () => {
  ...
  return (
    <div className="pl-page">
      ...
      {/* ── Global Search Bar ── */}
      <div className="pl-search-bar-wrap">
        <div className="pl-search-bar">
          <FiSearch size={18} className="pl-search-icon" />
          <input
            type="text"
        ...
        <main className="pl-content">
          ...
          {!isAuthenticated && (
            <div className="pl-welcome">
              👋 Welcome! Browse and add to cart freely —{" "}
              <a href="/login">sign in</a> to complete your purchase.
            </div>
          )}
