...
export const generateWebSiteJsonLD = () => {
  return {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://infinitycraftspace.com/products?search={search_term_string}",
...
export const generateMetaKeywords = (baseKeywords, product = null, category = null) => {
  ...
  keywords.push('craft supplies', 'art materials', 'creative supplies', 'handmade', 'DIY');
...
export const enhanceAccessibility = () => {
  ...
  skipLink.style.cssText = 'top: 0; left: 0; z-index: 9999; padding: 8px; background: #000; color: #fff; text-decoration: none;';
