    ...
    <>
              ...
              {isAuthenticated && !user?.isAdmin && (
                <Nav.Link 
                  ...
                  style={{ 
                    ...
                    borderRadius: "8px",
                    margin: "0 0.25rem",
                    color: location.pathname === "/orders" ? "#22d3ee" : "#e2e8f0"
                  }}
                >
      ...
      >
        ...
        <Offcanvas.Body style={{ padding: "1.5rem" }}>
            ...
            {!user?.isAdmin && (
              <Nav.Link 
                ...
                style={{ 
                  ...
                  borderRadius: "8px",
                  color: location.pathname === "/" ? "#22d3ee" : "#e2e8f0",
                  backgroundColor: location.pathname === "/" ? "rgba(34, 211, 238, 0.1)" : "transparent"
                }}
              >
            ...
            {isAuthenticated && !user?.isAdmin && (
              <Nav.Link 
                ...
                style={{ 
                  ...
                  borderRadius: "8px",
                  color: location.pathname === "/orders" ? "#22d3ee" : "#e2e8f0",
                  backgroundColor: location.pathname === "/orders" ? "rgba(34, 211, 238, 0.1)" : "transparent"
                }}
              >
          ...
          {isAuthenticated ? (
            <div>
              <div className="d-flex align-items-center mb-3 p-3" style={{ backgroundColor: "rgba(255,255,255,0.1)", borderRadius: "8px" }}>
