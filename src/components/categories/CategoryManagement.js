                            ...
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <small className="text-muted">
                                  Created by{" "}
                                  {category.createdBy?.username || "Admin"}
                                </small>
                              </div>
                            </div>
                          </td>
          ...
          <Modal.Body>
            ...
            {deleteItem.type === "category" && (
              <Alert variant="warning" className="mt-3">
                <small>
                  <strong>Warning:</strong> This will also affect all products
                  in this category. The category will be deactivated rather than
                  permanently deleted.
                </small>
              </Alert>
            )}
