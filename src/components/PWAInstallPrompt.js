    ...
    <Modal show={showModal} onHide={() => setShowModal(false)} centered>
      ...
      <Modal.Body>
        <div className="text-center">
          <div className="mb-3">
            <img src="/logo192.png" alt="App Icon" width="80" height="80" style={{ borderRadius: '16px' }} />
          </div>
          ...
          <div className="d-flex flex-column gap-2 text-start">
            <div className="d-flex align-items-center">
              ...
              <svg width="20" height="20" className="ms-2" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            ...
            <div>
              <strong style={{ fontSize: '1.1rem' }}>Install Infinity Craft App</strong>
